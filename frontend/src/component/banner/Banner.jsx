...
const Banner = () => {
  ...
  useEffect(() => {
    const fetchalluser = async () => {
      const res = await axios.get("https://UniFinderbackend-ankitkr437.onrender.com/api/users/");
      setusers(res.data);
      setisuser(true);
    };
    const fetchallnotes = async () => {
      const res = await axios.get("https://UniFinderbackend-ankitkr437.onrender.com/api/notes/");
      setnotes(res.data);
      setisnotes(true);
    };
    fetchallnotes();
